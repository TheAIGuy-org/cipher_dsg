...
*EXCEPTION FOR MATHEMATICAL DEPENDENCIES:* If the change involves inserting new formulation rows or altering quantitative mass (percentages, Natural Origin Index), you MUST ALSO flag Natural origin or any downstream section that calculates totals from the formula. NEVER exclude Natural Origin when a formulation component is added or modified! Always determine this dynamically by checking if the section calculates qualitative totals.
